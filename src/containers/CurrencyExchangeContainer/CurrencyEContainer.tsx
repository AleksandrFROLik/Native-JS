...
import {
    selectAllStateCurrency,
    selectAmountOfBYN, selectAmountOfCurrency,
    selectCurrencies,
    selectCurrentCurrency,
    selectIsBuying
} from "../../lessons/lesson1/selektors";
...
const CurrencyEContainer: React.FC<TProps> = props => {
    ...
    const {
        ...
        amountOfBYN,
        amountOfCurrency,
    } = useSelector(selectAllStateCurrency) ; // дисриктуризируем весь state,  это необходимо если компоненте нужен весь state.
